...
<head>
	...
	<script type="text/javascript">
		...
		// 	_SELECT('visitRecord').width = 0;
		// 	_SELECT('visitRecord').height = 0;
		// 	var t = (new Date()).valueOf();
		// 	_SELECT('visitRecord').src = "http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/record.png?t=" + t + "&record=no&programa_id=&item_id=";
		// }
		...
		// 	var t = (new Date()).valueOf();
		// 	_SELECT('visitRecord').src = "http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/record.png?action=visitUrlRecord&visitPathname=" +
		// 		visitPathname + "&visitSearch=" + visitSearch + "&t=" + t;
		// }


		var backUrl = "animation_index.jsp?focus_id=bt_bf4&home_perv_num=<%=home_perv_num+"&home_focus_id="+home_focus_id+"&home_from="+home_from%>&backUrl=<%=backUrl_encode%>";
		...
		var pageSum,curList;
	    var p = "<%="".equals(perv_num)?"1":perv_num %>";
		var pf_focus_id = '';
	   var focus_id ="<%="animation_history".equals(back)?("".equals(focus_id)?"bt_f0":focus_id):"bt_f0" %>";
		var pf_f = focus_id;
		function initdatas(){
			item_id = [];
			seriesCp_cpCode = [];
			...
			var url = webset.api+"history/<%=programType%>.json?userid="+userId+"&pageNo="+p;
			$.get(url, function (result) {
				...
				if (json.nextPreloadPageList != "") {
					$.each(json.nextPreloadPageList, function (i, item) {
						if (i < 6) {
							blockDiv("d_b" + i);
		...
		function F_E_F0() {
			...
			var _stat="影视聚合-动画-用户历史-"+title;
       		setTimeout("_STAT('"+_stat+"')", 1);
       		
	       commen_play(curList[i].id,'<%=programType%>','<%=HttpLinkUtils.getProgramType_ZH(programType)%>',curList[i].code,curList[i].cpCode,"&back=animation_history&focus_id=" + focus_id+"&perv_num="+p);
		}
		...
		function F_KEY_G_2() {
			if ((p - 1) > 0) {
				...
				seriesCp_cpCode = [];
				seriesCp_name = [];
				var url = webset.api+"history/<%=programType%>.json?userid="+userId+"&pageNo="+(p - 1);
				$.get(url, function (result) {
					var json = eval('(' + result + ')');
					p = json.currentPage;
					pageSum = json.totalPage;
		...
		function F_KEY_GO_PAGE(index1) {
			if (index1 > 0 && index1 <= pageSum) {
				...
				seriesCp_cpCode = [];
				seriesCp_name = [];
				var url = webset.api+"history/<%=programType%>.json?userid="+userId+"&pageNo="+index1;
				$.get(url, function (result) {
					var json = eval('(' + result + ')');
					p = json.currentPage;
					pageSum = json.totalPage;
...
<body onload="initdatas()" bgcolor="transparent">
	<img src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-bg06.jpg" style="position:absolute;left:0px;top:0px;width:1280px;height:720px;">
	...
	<div id="itempage">
		<div id="div_f0" style="position:absolute;left:104px;top:88px; display:none;">
			<img id="bt_s0" style="position: absolute;left:14px;top:12px;width:131px;height:197px;z-index:11;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png">
			<img id="bt_jb0" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p0" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>
		<div id="div_f1" style="position:absolute;left:285px;top:88px; display:none;">
			...
			<img id="bt_jb1" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p1" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>
		<div id="div_f2" style="position:absolute;left:466px;top:88px; display:none;">
			...
			<img id="bt_jb2" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p2" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>
		<div id="div_f3" style="position:absolute;left:647px;top:88px; display:none;">
			...
			<img id="bt_jb3" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p3" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>
		<div id="div_f4" style="position:absolute;left:828px;top:88px; display:none;">
			...
			<img id="bt_jb4" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p4" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>
		<div id="div_f5" style="position:absolute;left:1009px;top:88px; display:none;">
			...
			<img id="bt_jb5" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p5" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>
		<div id="div_f6" style="position:absolute;left:104px;top:371px; display:none;">
			...
			<img id="bt_jb6" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p6" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>
		<div id="div_f7" style="position:absolute;left:285px;top:371px; display:none;">
			...
			<img id="bt_jb7" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p7" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>
		<div id="div_f8" style="position:absolute;left:466px;top:371px; display:none;">
			...
			<img id="bt_jb8" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p8" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>
		<div id="div_f9" style="position:absolute;left:647px;top:371px; display:none;">
			...
			<img id="bt_jb9" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p9" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>
		<div id="div_f10" style="position:absolute;left:828px;top:371px; display:none;">
			...
			<img id="bt_jb10" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p10" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>
		<div id="div_f11" style="position:absolute;left:1009px;top:371px; display:none;">
			...
			<img id="bt_jb11" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="">
			...
			<div style="position:absolute;left:10px;top:230px; width:110px;height:25px;z-index:11;">
				<p id="bt_2p11" class="p1" style="position:absolute; left:0px; top:0px; width:110px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:gray; overflow:hidden; margin:0; padding:0;z-index:100">更新至第2集</p>
			</div>
		</div>

		<div id="d_b0" style="position:absolute;left:104px;top:459px;display: none;">
			<div id="div_b0" style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png');background-repeat:no-repeat;background-size:100%;background-position:0px 148px;width:131px;height:197px;position: absolute;left:14px;top:62px;z-index:10;">
			</div>
			<img id="im_b0" style="position: absolute;left:14px;top:210px;width:61px;height:49px;z-index:10;" src="">
		...
		<div id="d_b1" style="position:absolute;left:285px;top:459px;display: none;">
			<div id="div_b1" style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png');background-repeat:no-repeat;background-size:100%;background-position:0px 148px;width:131px;height:197px;position: absolute;left:14px;top:62px;z-index:10;">
			</div>
			<img id="im_b1" style="position: absolute;left:14px;top:210px;width:61px;height:49px;z-index:10;" src="">
			<div style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-white.png');background-repeat:no-repeat;background-size:100%;background-position:0px 194px;width:163px;height:259px;position: absolute;left:0px;top:0px;z-index:1;">
			</div>
		...
		<div id="d_b2" style="position:absolute;left:466px;top:459px;display: none;">
			<div id="div_b2" style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png');background-repeat:no-repeat;background-size:100%;background-position:0px 148px;width:131px;height:197px;position: absolute;left:14px;top:62px;z-index:10;">
			</div>
			<img id="im_b2" style="position: absolute;left:14px;top:210px;width:61px;height:49px;z-index:10;" src="">
			<div style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-white.png');background-repeat:no-repeat;background-size:100%;background-position:0px 194px;width:163px;height:259px;position: absolute;left:0px;top:0px;z-index:1;">
			</div>
		...
		<div id="d_b3" style="position:absolute;left:647px;top:459px;display: none;">
			<div id="div_b3" style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png');background-repeat:no-repeat;background-size:100%;background-position:0px 148px;width:131px;height:197px;position: absolute;left:14px;top:62px;z-index:10;">
			</div>
			<img id="im_b3" style="position: absolute;left:14px;top:210px;width:61px;height:49px;z-index:10;" src="">
			<div style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-white.png');background-repeat:no-repeat;background-size:100%;background-position:0px 194px;width:163px;height:259px;position: absolute;left:0px;top:0px;z-index:1;">
			</div>
		...
		<div id="d_b4" style="position:absolute;left:828px;top:459px;display: none;">
			<div id="div_b4" style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png');background-repeat:no-repeat;background-size:100%;background-position:0px 148px;width:131px;height:197px;position: absolute;left:14px;top:62px;z-index:10;">
			</div>
			<img id="im_b4" style="position: absolute;left:14px;top:210px;width:61px;height:49px;z-index:10;" src="">
			<div style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-white.png');background-repeat:no-repeat;background-size:100%;background-position:0px 194px;width:163px;height:259px;position: absolute;left:0px;top:0px;z-index:1;">
			</div>
		...
		<div id="d_b5" style="position:absolute;left:1009px;top:459px;display: none;">
			<div id="div_b5" style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png');background-repeat:no-repeat;background-size:100%;background-position:0px 148px;width:131px;height:197px;position: absolute;left:14px;top:62px;z-index:10;">
			</div>
			<img id="im_b5" style="position: absolute;left:14px;top:210px;width:61px;height:49px;z-index:10;" src="">
			<div style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-white.png');background-repeat:no-repeat;background-size:100%;background-position:0px 194px;width:163px;height:259px;position: absolute;left:0px;top:0px;z-index:1;">
			</div>
		...
		<div style="position: absolute;left:1006px;top:10px;">
			<p id="n_s" style="position:absolute; left:0px; top:0px; width:220px; height:35px; line-height:35px; text-align:left; font-size:23px; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;"></p>
		</div>
	</div>
