...
<head>
	...
	<script type="text/javascript">
		...
		var backUrl = "animation_index.jsp?focus_id=bt_af0<%=pervUrl%>";
	    ...
	    //历史焦点参数	
		var programa_id_left = "<%="".equals(programa_id)?"871914c15c4b794a845731b94197d8f4":programa_id%>";//左边code
...
//左边code从上到下
		_programa_id_left.push('871914c15c4b794a845731b94197d8f4');
		_programa_id_left.push('bfd966c5a621a4a241b2f822b476c44a');
		_programa_id_left.push('7266a03b0c502f739ffda09fe0f1a5d5');
		_programa_id_left.push('62be6c19ac6befd1e8485758f40ff983');
		_programa_id_left.push('c0aba353e4fff64faa63f7d0aa480f42');
		
		_programa_title_left.push('热播');
		_programa_title_left.push('冒险');
		_programa_title_left.push('卡通');		
		_programa_title_left.push('更多');
		_programa_title_left.push('免费');
		
		function F_E_PF0() {
			var bg = pf_focus_id;
			var upwzid = bg.replace("p", "wz"); //上一个栏目对应的文字id;
			_SELECT(upwzid).style.color = "#ffffff";
			nowid = '871914c15c4b794a845731b94197d8f4';
		...
		function F_E_PF1() {
			...
			var upwzid = bg.replace("p", "wz"); //上一个栏目对应的文字id;
			_SELECT(upwzid).style.color = "#ffffff";
			nowid = 'bfd966c5a621a4a241b2f822b476c44a';
		...
		function F_E_PF2() {
			...
			var upwzid = bg.replace("p", "wz"); //上一个栏目对应的文字id;
			_SELECT(upwzid).style.color = "#ffffff";
			nowid = '7266a03b0c502f739ffda09fe0f1a5d5';
		...
		function F_E_PF3() {
			...
			var upwzid = bg.replace("p", "wz"); //上一个栏目对应的文字id;
			_SELECT(upwzid).style.color = "#ffffff";
			nowid = '62be6c19ac6befd1e8485758f40ff983';
		...
		function F_E_PF4() {
			...
			var upwzid = bg.replace("p", "wz"); //上一个栏目对应的文字id;
			_SELECT(upwzid).style.color = "#ffffff";
			nowid = 'c0aba353e4fff64faa63f7d0aa480f42';
			leftTitle = _programa_title_left[4];
			if (timeboolean == 1) {
				if (programa_id_left != nowid) {
					timecount(F_E_PF4, nowid);
				}
			} else {
				if (programa_id_left != nowid) {
					item_id = [];
...
//						_SELECT("bt_2p" + i).innerHTML = "共" + item.volumnCount + "集 已完结";
		...
		function F_E_F0() {
            ...
            var _stat="影视聚合-动画-看动画-"+leftTitle+"-"+_title;
       		setTimeout("_STAT('"+_stat+"')", 1);
       		
			commen_play(_id,_programType,_programType2,_code,_cpcode,"&back=animation_kdh_list&programa_id=" + programa_id_left 
...
<body onload="initdatas()" bgcolor="transparent">
	<img src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-bg01.jpg" style="position:absolute;left:0px;top:0px;width:1280px;height:720px;">
	...
	<div style="position:absolute;left:100px;top:310px; width:120px;height:40px;z-index:11;">
		<p id="bt_wzf2" style="position:absolute; left:0px; top:0px; width:120px; height:40px; line-height:40px; text-align:left; font-size:32px;font-family:微软雅黑; font-weight:600; color:#ffffff; overflow:hidden; margin:0; padding:0;">卡通</p>
	</div>
	...
	<div style="position:absolute;left:100px;top:470px; width:120px;height:40px;z-index:11;">
		<p id="bt_wzf4" style="position:absolute; left:0px; top:0px; width:120px; height:40px; line-height:40px; text-align:left; font-size:32px;font-family:微软雅黑; font-weight:600; color:#ffffff; overflow:hidden; margin:0; padding:0;">免费</p>
	</div>

	<div style="position:absolute;left:45px;top:452px;">
		<img id="bt_pf4" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;width:186px;height:91px;">
	</div>
	...
	<div id="itempage">
		<div id="div_f0" style="position: absolute; left: 285px; top: 88px; display: block;">
			...
			<img id="bt_jb0" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-poster-hy.png">
		...
		<div id="div_f1" style="position: absolute; left: 466px; top: 88px; display: block;">
			...
			<img id="bt_jb1" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-poster-hy.png">
		...
		<div id="div_f2" style="position: absolute; left: 647px; top: 88px; display: block;">
			...
			<img id="bt_jb2" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-poster-hy.png">
		...
		<div id="div_f6" style="position: absolute; left: 466px; top: 371px; display: block;">
			...
			<img id="bt_jb6" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-poster-mf.png">
		...
		<div id="div_f7" style="position: absolute; left: 647px; top: 371px; display: block;">
			...
			<img id="bt_jb7" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-poster-mf.png">
		...
		<div id="div_f9" style="position: absolute; left: 1009px; top: 371px; display: block;">
			...
			<img id="bt_jb9" style="position: absolute;left:14px;top:12px;width:61px;height:60px;z-index:11;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-poster-mf.png">
		...
		<div id="d_b0" style="position: absolute; left: 285px; top: 459px; display: block;">
			<div id="div_b0" style="background-image: url(&quot;http://pic.youku.ahct.lv1.vcache.cn/asset/inject/050E0000525F416567583974A90C31A9.jpg&quot;); background-repeat: no-repeat; background-size: 100% auto; background-position: 0px 148px; width: 131px; height: 197px; position: absolute; left: 14px; top: 62px; z-index: 10;">
			</div>
			<img id="im_b0" style="position: absolute;left:14px;top:210px;width:61px;height:49px;z-index:10;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-poster-mf.png">
		...
		<div id="d_b1" style="position: absolute; left: 466px; top: 459px; display: block;">
			<div id="div_b1" style="background-image: url(&quot;http://pic.youku.ahct.lv1.vcache.cn/asset/inject/050E00005743CE8567BC3C2803068A92.jpg&quot;); background-repeat: no-repeat; background-size: 100% auto; background-position: 0px 148px; width: 131px; height: 197px; position: absolute; left: 14px; top: 62px; z-index: 10;">
			</div>
		...
		<div id="d_b2" style="position: absolute; left: 647px; top: 459px; display: block;">
			<div id="div_b2" style="background-image: url(&quot;http://pic.youku.ahct.lv1.vcache.cn/asset/inject/050E00005192EEE4670C4A1ADE0DEC6C.jpg&quot;); background-repeat: no-repeat; background-size: 100% auto; background-position: 0px 148px; width: 131px; height: 197px; position: absolute; left: 14px; top: 62px; z-index: 10;">
			</div>
		...
		<div id="d_b3" style="position: absolute; left: 828px; top: 459px; display: block;">
			<div id="div_b3" style="background-image: url(&quot;http://pic.imgo2.ahct.lv1.vcache.cn/images/20170428/223967/91030001000000080000000000027083.jpg&quot;); background-repeat: no-repeat; background-size: 100% auto; background-position: 0px 148px; width: 131px; height: 197px; position: absolute; left: 14px; top: 62px; z-index: 10;">
			</div>
			<img id="im_b3" style="position: absolute;left:14px;top:210px;width:61px;height:49px;z-index:10;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-poster-hy.png">
			<div style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-white.png');background-repeat:no-repeat;background-size:100%;background-position:0px 194px;width:163px;height:259px;position: absolute;left:0px;top:0px;z-index:1;">
			</div>
		...
		<div id="d_b4" style="position: absolute; left: 1009px; top: 459px; display: block;">
			<div id="div_b4" style="background-image: url(&quot;http://pic.imgo2.ahct.lv1.vcache.cn/images/20170328/206893/91030001000000080000000000025440.jpg&quot;); background-repeat: no-repeat; background-size: 100% auto; background-position: 0px 148px; width: 131px; height: 197px; position: absolute; left: 14px; top: 62px; z-index: 10;">
			</div>
			<img id="im_b4" style="position: absolute;left:14px;top:210px;width:61px;height:49px;z-index:10;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-poster-hy.png">
			<div style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-white.png');background-repeat:no-repeat;background-size:100%;background-position:0px 194px;width:163px;height:259px;position: absolute;left:0px;top:0px;z-index:1;">
			</div>
		...
		<div style="position: absolute;left:1006px;top:10px;">
			<p id="n_s" style="position:absolute; left:0px; top:0px; width:220px; height:35px; line-height:35px; text-align:left; font-size:23px; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;">当前第1页/共3页</p>
		</div>
	</div>
	...
	<div style="position:absolute;left:0px;top:0px;">
		<img id="bt_pdg_f" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;width:0px;height:0px;">
	</div>
