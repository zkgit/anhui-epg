...
<head>
	...
	<script type="text/javascript">
		...
		var backUrl = "animation_index.jsp?focus_id=bt_af3<%=pervUrl%>";
		...
		var buttons = [
			//左边光标
			{
				...
				focusFun: 'F_E_PF0',
				enterFun: '',
				focusImage: 'anime-item-left-f2.png',
				blurImage: 'Pixel.png'
			},
			{
				id: 'bt_pf1',
		...
		var nowid = "";
//历史焦点参数	
// 		var programa_id_left = "92b300ada0b49557e200378fd0becba3"; //左边code
// 		var pf_focus_id = 'bt_pf0';//左边文字高亮焦点
// 		var focus_id = 'bt_pf0';//左边及右边focus焦点
// 		var pf_f = 'bt_f0';//focus参数
// 		var p; //页数：没有取1
		
		var programa_id_left = "<%="".equals(programa_id)?"92b300ada0b49557e200378fd0becba3":programa_id%>";//左边code
...
//左边code从上到下		
		_programa_id_left.push('92b300ada0b49557e200378fd0becba3');
		_programa_id_left.push('8de09e19c9e0c4cd923572d8a7d4168c');
		_programa_id_left.push('ee6927bacd3c7aac958933d16ff61556');
		_programa_id_left.push('a1d7ea6ee64ffadf0a00c98a01faa56e');
				
		_programa_title_left.push('热播');
		_programa_title_left.push('儿歌');
		_programa_title_left.push('亲子');		
		...
		function F_E_PF0() {
			...
			nowid = '92b300ada0b49557e200378fd0becba3';
		...
		function F_E_PF1() {
			...
			var upwzid = bg.replace("p", "wz"); //上一个栏目对应的文字id;
			_SELECT(upwzid).style.color = "#ffffff";
			nowid = '8de09e19c9e0c4cd923572d8a7d4168c';
		...
		function F_E_PF2() {
			...
			var upwzid = bg.replace("p", "wz"); //上一个栏目对应的文字id;
			_SELECT(upwzid).style.color = "#ffffff";
			nowid = 'ee6927bacd3c7aac958933d16ff61556';
		...
		function F_E_PF3() {
			...
			var upwzid = bg.replace("p", "wz"); //上一个栏目对应的文字id;
			_SELECT(upwzid).style.color = "#ffffff";
			nowid = 'a1d7ea6ee64ffadf0a00c98a01faa56e';
...
//						_SELECT("bt_2p" + i).innerHTML = "共" + item.volumnCount + "集 已完结";
		...
		function F_E_F0() {
            ...
            var _stat="影视聚合-动画-益智-"+leftTitle+"-"+_title;
            setTimeout("_STAT('"+_stat+"')", 1);
            
			commen_play(_id,_programType,_programType2,_code,_cpcode,"&back=animation_yz_list&programa_id=" + programa_id_left 
...
<body onload="initdatas()" bgcolor="transparent">
	<img src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-bg05.jpg" style="position:absolute;left:0px;top:0px;width:1280px;height:720px;">
	<div id="DIV_F" style="position: absolute; left: 45px; top: 132px; z-index: 11;">
		<img id="IMG_F" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-item-left-f2.png">
	</div>
	...
	<div style="position:absolute;left:100px;top:230px; width:120px;height:40px;z-index:11;">
		<p id="bt_wzf1" style="position:absolute; left:0px; top:0px; width:120px; height:40px; line-height:40px; text-align:left; font-size:32px;font-family:微软雅黑; font-weight:600; color:#ffffff; overflow:hidden; margin:0; padding:0;">儿歌</p>
	</div>
	...
	<div style="position:absolute;left:100px;top:310px; width:120px;height:40px;z-index:11;">
		<p id="bt_wzf2" style="position:absolute; left:0px; top:0px; width:120px; height:40px; line-height:40px; text-align:left; font-size:32px;font-family:微软雅黑; font-weight:600; color:#ffffff; overflow:hidden; margin:0; padding:0;">亲子</p>
	</div>
	...
	<div id="itempage">
		...
		<div id="d_b0" style="position: absolute; left: 285px; top: 459px; display: block;">
			<div id="div_b0" style="background-image: url(&quot;http://pic.youku.ahct.lv1.vcache.cn/asset/inject/050E0000589C039767BC3C4C080538BA.jpg&quot;); background-repeat: no-repeat; background-size: 100% auto; background-position: 0px 148px; width: 131px; height: 197px; position: absolute; left: 14px; top: 62px; z-index: 10;">
			</div>
		...
		<div id="d_b1" style="position: absolute; left: 466px; top: 459px; display: block;">
			<div id="div_b1" style="background-image: url(&quot;http://pic.youku.ahct.lv1.vcache.cn/asset/inject/050E0000589C02E467BC3C47F70B689C.jpg&quot;); background-repeat: no-repeat; background-size: 100% auto; background-position: 0px 148px; width: 131px; height: 197px; position: absolute; left: 14px; top: 62px; z-index: 10;">
			</div>
			<img id="im_b1" style="position: absolute;left:14px;top:210px;width:61px;height:49px;z-index:10;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-poster-hy.png">
			<div style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-white.png');background-repeat:no-repeat;background-size:100%;background-position:0px 194px;width:163px;height:259px;position: absolute;left:0px;top:0px;z-index:1;">
			</div>
		...
		<div id="d_b2" style="position: absolute; left: 647px; top: 459px; display: block;">
			<div id="div_b2" style="background-image: url(&quot;http://pic.imgo2.ahct.lv1.vcache.cn/images/20161101/111931/91030001000000080000000000014078.jpg&quot;); background-repeat: no-repeat; background-size: 100% auto; background-position: 0px 148px; width: 131px; height: 197px; position: absolute; left: 14px; top: 62px; z-index: 10;">
			</div>
			<img id="im_b2" style="position: absolute;left:14px;top:210px;width:61px;height:49px;z-index:10;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-poster-hy.png">
			<div style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/anime-white.png');background-repeat:no-repeat;background-size:100%;background-position:0px 194px;width:163px;height:259px;position: absolute;left:0px;top:0px;z-index:1;">
			</div>
		...
		<div id="d_b3" style="position: absolute; left: 828px; top: 459px; display: block;">
			<div id="div_b3" style="background-image: url(&quot;http://pic.youku.ahct.lv1.vcache.cn/asset/inject/050E00005824048D67BC3C2185093E44.jpg&quot;); background-repeat: no-repeat; background-size: 100% auto; background-position: 0px 148px; width: 131px; height: 197px; position: absolute; left: 14px; top: 62px; z-index: 10;">
			</div>
		...
		<div id="d_b4" style="position: absolute; left: 1009px; top: 459px; display: block;">
			<div id="div_b4" style="background-image: url(&quot;http://pic.youku.ahct.lv1.vcache.cn/asset/inject/050E000057A3EEEA67BC3C0B580983CC.jpg&quot;); background-repeat: no-repeat; background-size: 100% auto; background-position: 0px 148px; width: 131px; height: 197px; position: absolute; left: 14px; top: 62px; z-index: 10;">
			</div>
