...
<%
    ...
    if(!"".equals(RequestUtil.getString("backurl", request))){
		home_focus_id="zhuanti";
	}
...
<body bgcolor="transparent" onload="initdatas()" >
    <img style="left: 0px; top: 0px; width: 1280px; height: 720px; position: absolute;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detail-bg.png">
    ...
    <div style="left: 611px; top: 45px; width: 450px; height: 50px; position: absolute;">
        <div>
            <p style="margin: 0px; padding: 0px; left: 0px; top: 0px; width: 450px; height: 50px; text-align: left; color: rgb(255, 255, 255); line-height: 50px; overflow: hidden; font-family: 微软雅黑; font-size: 38px; font-weight: normal; position: absolute;">
                <%=RequestUtil.replaceNull(seriesDetail.getTitle()) %>
            </p>
        </div>
    </div>
    <div style="left: 611px; top: 95px; width: 530px; height: 30px; position: absolute;">
        <div style="left: 0px; top: 0px; width: 260px; height: 30px; position: absolute;">
            <h2 style="margin: 0px; padding: 0px; left: 0px; top: 0px; width: 61px; text-align: left; color: rgb(255, 255, 255); overflow: hidden; font-family: 微软雅黑; font-size: 18px; font-weight: normal; position: absolute;">
                <%=RequestUtil.replaceNull(seriesDetail.getYear()) %>年
            </h2>
            <h2 id="item_category" style="margin: 0px; padding: 0px; left: 58px; top: 0px; height: 23px; text-align: left; color: rgb(255, 255, 255); line-height: 25px; overflow: hidden; font-family: 微软雅黑; font-size: 18px; font-weight: normal; position: absolute;"></h2>
        </div>
    ...
    <div style="left: 611px; top: 125px; width: 580px; height: 40px; position: absolute;">
        <div style="left: 0px; top: 0px; width: 580px; height: 40px; position: absolute;">
            <h2 style="margin: 0px; left: 0px; top: 0px; width: 46px; text-align: left; color: rgb(255, 255, 255); overflow: hidden; padding-top: 5px; font-family: 微软雅黑; font-size: 18px; font-weight: normal; position: absolute;">演员:</h2>
            <h2 id="item_guest" style="margin: 0px; padding: 0px; left: 46px; top: 0px; text-align: left; color: rgb(255, 255, 255); overflow: hidden; font-family: 微软雅黑; font-size: 18px; font-weight: normal; position: absolute;margin-top:5px"></h2>
...
%>
    ...
    <div style="left: 611px; top: 176px; width: 590px; height: 130px; position: absolute;">
        <p id="dec" style="margin: 0px; padding: 0px; left: 0px; top: 0px; text-align: left; color: rgb(255, 255, 255); line-height: 30px; overflow: hidden; font-family: 微软雅黑; font-size: 19px; font-weight: normal; position: absolute;height: 82px;word-wrap: break-word;">
        简介:
            <%=RequestUtil.replaceNull(seriesDetail.getDescription()) %>
        </p>
        <p style="margin: 0px; padding: 0px; left: 515px; top: 105px; width: 100px; text-align: left; color: rgb(92, 240, 240); overflow: hidden; font-family: 微软雅黑; font-size: 20px; font-weight: normal; position: absolute;">【全文】</p>
        <img id="bt_bqw" style="left: 500px; top: 82px; width: 108px; height: 64px; position: absolute;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png"> </div>
    ...
    <div id="div_prevWatch" style="left: 594px; top: 311px; width: 280px; height: 55px; visibility: hidden; position: absolute; z-index: 1; background-image: url(http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detail-watch-tip.png); background-repeat: no-repeat;background-size: 280px auto;"></div>
    ...
    <div id="sk_memo" style="left: 0px; top: 0px; visibility: hidden; position: absolute; z-index: 12;">
        <img style="left: 0px; top: 0px; width: 1280px; height: 720px; position: absolute;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detail-sk-alert.png">
        <img style="left: 535px; top:192px; width: 210px; height:210px; position: absolute;" id="sk-er" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png">

        <!-- 返回按钮 -->
        <div style="left: 1110px; top: 45px; position: absolute;">
        <img id="bt_kh" style="left: 10px; top: 5px; position: absolute;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/icon-back.png">
        <img id="bt_bhk" style="left: 0px; top: 0px; width: 87px; height: 104px; position: absolute;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detail-zanbg-f.png">
        </div>
    </div>
    ...
    <div id="qw_memo" style="left: 0px; top: 0px; visibility: hidden; position: absolute; z-index: 12;">
        ...
        <div style="left: 215px; top: 190px; width: 870px; height: 420px; position: absolute;">
            <div class="deczhan" id="deczhan" style="margin: 0px; padding: 0px; width: 870px; height: 416px; text-align: left; color: rgb(255, 255, 255); line-height: 35px; letter-spacing: 8px; overflow: hidden; font-size: 25px; font-weight: normal; position: relative;">
                <p> 简介：
                    <%=RequestUtil.replaceNull(seriesDetail.getDescription()) %>
                </p>
            </div>
    ...
    <div id="scrollid" style="top: 425px; width: 1250px; height: 295px; overflow: hidden; position: absolute; z-index: 9;">
        ...
        <div id="div_f12" style="left: 2420px; display: block; position: absolute;">
            ...
            <p class="p0" id="bt_p12" style="margin: 0px; padding: 0px; left: 20px; top: 247px; width: 166px; height: 23px; text-align: center; color: rgb(255, 255, 255); line-height: 25px; overflow: hidden; font-family: 微软雅黑; font-weight: normal; position: absolute;"></p>
        </div>
        <div id="div_f13" style="left: 2618px; display: block; position: absolute;">
            ...
            <p class="p0" id="bt_p13" style="margin: 0px; padding: 0px; left: 20px; top: 247px; width: 166px; height: 23px; text-align: center; color: rgb(255, 255, 255); line-height: 25px; overflow: hidden; font-family: 微软雅黑; font-weight: normal; position: absolute;"></p>
        </div>
        <div id="div_f14" style="left: 2816px; display: block; position: absolute;">
            ...
            <p class="p0" id="bt_p14" style="margin: 0px; padding: 0px; left: 20px; top: 247px; width: 166px; height: 23px; text-align: center; color: rgb(255, 255, 255); line-height: 25px; overflow: hidden; font-family: 微软雅黑; font-weight: normal; position: absolute;"></p>
        </div>
        <div id="div_f15" style="left: 3014px; display: block; position: absolute;">
            ...
            <p class="p0" id="bt_p15" style="margin: 0px; padding: 0px; left: 20px; top: 247px; width: 166px; height: 23px; text-align: center; color: rgb(255, 255, 255); line-height: 25px; overflow: hidden; font-family: 微软雅黑; font-weight: normal; position: absolute;"></p>
        </div>
        <div id="div_f16" style="left: 3212px; display: block; position: absolute;">
            ...
            <p class="p0" id="bt_p16" style="margin: 0px; padding: 0px; left: 20px; top: 247px; width: 166px; height: 23px; text-align: center; color: rgb(255, 255, 255); line-height: 25px; overflow: hidden; font-family: 微软雅黑; font-weight: normal; position: absolute;"></p>
        </div>
        <div id="div_f17" style="left: 3410px; display: block; position: absolute;">
            ...
            <p class="p0" id="bt_p17" style="margin: 0px; padding: 0px; left: 20px; top: 247px; width: 166px; height: 23px; text-align: center; color: rgb(255, 255, 255); line-height: 25px; overflow: hidden; font-family: 微软雅黑; font-weight: normal; position: absolute;"></p>
        </div>
   ...
   var cjson={
    ...
    window.document.onkeypress = function (keyEvent) {
        ...
        if (KV == KEY_G_0) {
            ...
            var str=window.location.href.replace('detail.jsp', 'detail1.jsp')
    ...
    var fmp,nativePlayerInstanceID,smallt;
    var smallflag=false;
    function init() {
        try {
        fmp = new MediaPlayer();
        ...
        fmp.setAllowTrickmodeFlag(0); //设置是否允许trick操作。 0：允许 1：不允许
        fmp.setVideoDisplayMode(0); //0:按setVideoDisplayArea中设定的left,top,width,height,来显示视频 1：全屏显示 2：按宽度显示 指在不改变原有图像纵横比的情况下按全屏宽度显示 3：按高度显示，指在不改变原有图像 纵横比的情况下按全屏高度显示 255: 视频显示窗口将被关闭。
        fmp.setVideoDisplayArea(62, 52, 532, 314); //left,top,width,height
        fmp.refreshVideoDisplay(); //刷新
    ...
    function F_M_0(flag) { //音量加减
      if(!fmp){return;}
     // var imgvolme=_SELECT("img_volume");
        try {
           var volume = fmp.getVolume(); //获取当前系统音量 0-100
            if (flag == '+') {
                if (volume < 96) {
                  volume = volume + 6;
            ...
            fmp.setVolume(volume); //设置当前系统音量 0-100
            //不存在img_volume  div_volume
           // imgvolme.style.display = "block";
           // imgvolme.src = "http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/window-vol"+ img_volume+".png"; //音量进程图1-17

            if (t1 != 0) clearTimeout(t1);
            t1 = setTimeout(function () {
               imgvolme.style.display = "none";
            }, 3000);
        } catch (e) {}
    }
    ...
    function F_KEY_G_5() { //up
         var upid=_BS[focus_id]['upButtonId'];
    	...
    	if('tc-success' == go_order_div){//吐槽成功
           ...
           if(smallt){clearInterval(smallt)}
            ...
            <%
        		String text="";
	        	if(perv_count==0){
	        		if("zhuanti".equals(home_focus_id)){//百视通单个专题
	        			text="window.history.go(-1)";
	        		}else if("VipMemberBack".equals(home_focus_id)){
	        			text="window.location.href = \"http://117.71.47.120:9191/epg/login.jsp\";";//会员中心返回
	        		}else if("".equals(back)||!"".equals(from)){
	        			if(!"".equals(from)){
...
//			rightButtonId: '',
    ...
    function F_E_PLAY() { //播放enter
        ...
        //public统一调取播放器
        F_B_PREVWATCH();
    	commen_play('<%=id%>', '<%=programType%>', '<%=HttpLinkUtils.getProgramType_ZH(programType)%>','<%=code%>', '<%=cpcode%>','<%=pervUrl%>',ordered,1);
    }



    function smallplay(json,cutime,order){
        var media = '[{mediaUrl:"' +json.url +'",mediaCode:"vod1",mediaType:2,audioType:1,videoType:3,streamType:2,drmType:1,fingerPrint:1,copyProtection:0,allowTrickmode:1,startTime:0,endTime:0,entryID:"entry1"}]';
        fmp.setSingleMedia(media); //设置媒体播放器播放媒体内容
        fmp.playFromStart();
         smallflag=true;
     if(parseInt(json.seriesBcharging)&&!order){//付费并且不是会员 电视剧，纪实大于3集，综艺大于1集
               if(cutime>=420){fmp.pause();}
                else{
                    if(cutime>10){
                        setTimeout(function(){
                          fmp.pause();fmp.playByTime(1, cutime, 1);
                        },1000);
                    }
                    smallt=setInterval(function(){
                        var currentPlayTime=fmp.getCurrentPlayTime();
    ...
    function F_M_stop() {
    fmp.stop(); //停止播放
    fmp.releaseMediaPlayer(nativePlayerInstanceID); //释放机顶盒MediaPlayer的对象，结束对应MediaPlayer的生命周期   返回0释放成功  返回-1释放失败
    }

    function playtishi(cutime) {
        var str = '';
        cutime = parseInt(cutime);
        var m = parseInt(cutime / 60);
        var s = parseInt(cutime - m * 60);
        if (m > 0) {
            str += m + '分'
        }
        if (s > 0) {
        ...
        _SELECT("div_prevWatch").innerHTML ="<div id='div_watchPosition'style='position:absolute;left:13px;top:8px; width:258px; height:55px; line-height:35px; text-align:center;font-size:20px; font-weight:600; color:#ffffff; overflow:hidden; margin:0; padding:0;'>您上次观看到" +str + "</div>";
    }
    var playjson,smallsrc;

    function F_F_PREVWATCH() { //播放focus获取播放到哪了
        if (!playjson) {
            if (cuttime&&cuttime > 10) {
                    playtishi(cuttime)
            }
            var url = webset.api +"video/getSeriesBySeriesCode.json?code=<%=code%>&cp=<%=cpcode%>&volumnCount=1&userId=" + userId;
            $.get(url, function (res) {
                ...
                if (res && res.response.responseHeader && res.response.responseHeader.code == '200') {
                    ...
                    if(smallflag){
                        ...
                        if(cuttime>10){
                            setTimeout(function(){
                              fmp.playByTime(1, cuttime, 1);
                            },1000);}
                        else{fmp.playByTime(1, 0, 1)}
                    }else{
                        setTimeout(function(){
                       smallplay(playjson,cuttime,ordered)
                        }, 300);
                     }
                }else{hasorder()}
            }, true);
...
//  	if(hasTC)return;
    ...
    var order_setime;
          ...
          var ordered = 1;
    function hasorder(){
            HAS_ORDER(userId, '<%=id%>', '<%=programType%>', '<%=seriesDetail.getTitle() %>',true,function(orderes){
 ...
 function orderenter() {
        ...
        var  cuttime = 0,tongyi;
    function countplaycallback(tongyi){
        console.log('tongyi',tongyi)
        if (tongyi.userId){
            if((tongyi.cuttime&&(cuttime!=parseInt(tongyi.cuttime)))||!tongyi.cuttime){
                if(_playtimer){clearInterval(_playtimer)}
    ...
    function countplay(){
     ...
     function UN_4K(){
        ...
        var skstr=serverBaseStatic+'itv-epg-api/api/v1/ad/image.json?content='+encodeURIComponent('http://ah.189.cn/r/cms/ah/default/activity/setTopBox/wap/home.html');
        ...
        getItemGuest();
        init();
        if(('<%=programa_name%>'=='4K'||'<%=seriesDetail.getTitle() %>'.indexOf('4K')>-1)&&UN_4K()){
           go_order_div = 'Q';
        visibleDiv("sk_memo");
        _H_F('bt_bhk');
        _SELECT('sk-er').src=skstr;
        }
        FYY();
    }
    ...
    function getDirector() { //处理导演
        ...
        if (item_director != "") {
            ...
            if (itemdirector.length > 0) {
                var newdirector = itemdirector[0].length?itemdirector[0]:itemdirector[1];
            } else {
                var newdirector=item_director;
            }
              _SELECT("a_item_director").innerHTML = newdirector;
              _SELECT("a_item_director").style.width=newdirector.length*24+18;
        } else {
            _SELECT("a_item_director").innerHTML = "";
        }
    }
    ...
    function F_TODETAIL() {
       ...
       if(_playtimer){clearInterval(_playtimer)}
        setTimeout(function(){
        	window.location.href = "detail.jsp?id=" + tjlist[i].id + "&programType=" + tjlist[i].videoType + "&code=" +
            tjlist[i].code + "&cpcode=" + tjlist[i].cpcode + '&prev_focus_id=' + focus_id + '<%=pervUrl%>';
        },80);
    }
