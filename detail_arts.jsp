...
<%
	...
	List<SeriesStar> starlist=seriesDetail.getStars();
	if(starlist==null){
...
<body bgcolor="transparent" onload="initdatas()">
        <img style="left: 0px; top: 0px; width: 1280px; height: 720px; position: absolute;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-bg.png">
        ...
        <div style="left: 62px; top: 52px; position: absolute;">
                <img style="left: 0px; top: 0px; width: 61px; height: 60px; position: absolute; z-index: 10;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png"
                        id="isfree"> </div>
        ...
        <div style="left: 611px; top: 125px; width: 580px; height: 40px; position: absolute;">
                <div style="left: 0px; top: 0px; width: 580px; height:40px; position: absolute;">
                        <h2 style="position:absolute;left:0px;top:0px;width:65px; text-align:left; font-size:18px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;padding-top:5px;">主持人:</h2>
                        <h2 id="item_guest" id1="item_director" style="position:absolute;left:65px;top:0px; text-align:left; font-size:18px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;"></h2>
                <div id="stars" style="margin: 0px; padding: 0px; left: 66px; top: 0px; width: 540px; height: 40px; text-align: left; color: rgb(255, 255, 255); overflow: hidden; font-family: 微软雅黑; font-size: 18px; font-weight: normal; position: absolute;">
                        <%
    int titlewidth=0;
int j=0;
...
%>
        ...
        <div style="position:absolute; left:611px;top:176px;width:510px;height:30px;">
                <p style="position:relative;left:0px;top:0px;width: 510px; height: 30px; line-height: 30px; text-align:left; font-size:18px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;">简介:
        ...
        <!-- 选集列表-->
        <div style="position:absolute;left:591px;top:203px;display:none;" id='bt_dra0'>
               <img id="bt_jbf0" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:20px;top:20px;width:30px;height:30px;z-index:10">
                <img src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-xdra-bg.png" style="position: absolute;left:20px;top:20px;;width:296px;height:38px;">
                <img id="bt_vf0" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:336px;height:78px;">
                <p id="bt_pf0" style="position:relative;left:30px;top:25px;width:276px; height:28px; line-height:30px; text-align:left; font-size:20px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
        </div>
        <div style="position:absolute;left:892px;top:203px;display:none;" id='bt_dra1'>
               <img id="bt_jbf1" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:20px;top:20px;width:30px;height:30px;z-index:10">
                <img src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-xdra-bg.png" style="position: absolute;left:20px;top:20px;;width:296px;height:38px;">
                <img id="bt_vf1" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:336px;height:78px;">
                <p id="bt_pf1" style="position:relative;left:30px;top:25px;width:276px; height:28px; line-height:30px; text-align:left; font-size:20px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
        </div>
        <div style="position:absolute;left:591px;top:246px;display:none;" id='bt_dra2'>
               <img id="bt_jbf2" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:20px;top:20px;width:30px;height:30px;z-index:10">
                <img src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-xdra-bg.png" style="position: absolute;left:20px;top:20px;;width:296px;height:38px;">
                <img id="bt_vf2" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:336px;height:78px;">
                <p id="bt_pf2" style="position:relative;left:30px;top:25px;width:276px; height:28px; line-height:30px; text-align:left; font-size:20px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
        </div>
        <div style="position:absolute;left:892px;top:246px;display:none;" id='bt_dra3'>
               <img id="bt_jbf3" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:20px;top:20px;width:30px;height:30px;z-index:10">
                <img src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-xdra-bg.png" style="position: absolute;left:20px;top:20px;;width:296px;height:38px;">
                <img id="bt_vf3" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:336px;height:78px;">
                <p id="bt_pf3" style="position:relative;left:30px;top:25px;width:276px; height:28px; line-height:30px; text-align:left; font-size:20px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
        </div>
        <div style="position:absolute;left:591px;top:289px;display:none;" id='bt_dra4'>
                <img id="bt_jbf4" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:20px;top:20px;width:30px;height:30px;z-index:10">
                <img src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-xdra-bg.png" style="position: absolute;left:20px;top:20px;;width:296px;height:38px;">
                <img id="bt_vf4" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:336px;height:78px;">
                <p id="bt_pf4" style="position:relative;left:30px;top:25px;width:276px; height:28px; line-height:30px; text-align:left; font-size:20px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
        </div>
        <div style="position:absolute;left:892px;top:289px;display:none;" id='bt_dra5'>
               <img id="bt_jbf5" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:20px;top:20px;width:30px;height:30px;z-index:10">
                <img src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-xdra-bg.png" style="position: absolute;left:20px;top:20px;;width:296px;height:38px;">
                <img id="bt_vf5" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:336px;height:78px;">
                <p id="bt_pf5" style="position:relative;left:30px;top:25px;width:276px; height:28px; line-height:30px; text-align:left; font-size:20px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
        </div>
        <div style="position:absolute;left:892px;top:289px;display:none;" id='bt_drall'>
                <img src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-xdra-bg.png" style="position: absolute;left:20px;top:20px;;width:296px;height:38px;">
                <img id="bt_vfall" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:336px;height:78px;">
                <p id="bt_pfall" style="position:relative;left:25px;top:25px;width:290px; height:30px; line-height:30px; text-align:center; font-size:20px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;">更多往期内容 &gt;&gt;</p>
        </div>
        ...
        <div style="left: 964px; top: 5px; position: absolute;">
                ...
                <img id="score_finish" style="left: 35px; top: 95px; position: absolute; z-index: 1;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png"> </div>
        ...
        <!--选集列表-->
        <div id="XJ_LIST" style="position:absolute;left:0px;top:0px;display:none;z-index:10;">
                <img src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detail-qwbg.png" style="position:absolute;left:0px;top:0px;width:1280px;height:720px">
                <div style="position: absolute;left:580px;top:70px;width:150px;height:50px;">
                        <p style="position:absolute; left:0px; top:0px; width:150px; height:50px; line-height:50px; text-align:center; font-size:35px; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;">全部选集</p>
                </div>
                <div id="bt_div0" style="position: absolute;left:216px;top:143px;visibility: hidden;">
                        <img id="bt_js0" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-js-b.png" style="position: absolute;left:0px;top:0px;width:121px; height:47px;">
                        <p id="bt_js_f0" style="position:relative; left:0px; top:11px; width:120px; height:30px; line-height:30px; text-align:center;
                font-size:30px; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;"></p>
                </div>
                <div id="bt_div1" style="position: absolute;left:346px;top:143px;visibility: hidden;">
                        <img id="bt_js1" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-js-b.png" style="position: absolute;left:0px;top:0px;width:121px; height:47px;">
                        <p id="bt_js_f1" style="position:relative; left:0px; top:11px; width:120px; height:30px; line-height:30px; text-align:center;
                font-size:30px; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;"></p>
                </div>
                <div id="bt_div2" style="position: absolute;left:476px;top:143px;visibility: hidden;">
                        <img id="bt_js2" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-js-b.png" style="position: absolute;left:0px;top:0px;width:121px; height:47px;">
                        <p id="bt_js_f2" style="position:relative; left:0px; top:11px; width:120px; height:30px; line-height:30px; text-align:center;
                font-size:30px; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;"></p>
                </div>
                <div id="bt_div3" style="position: absolute;left:606px;top:143px;visibility: hidden;">
                        <img id="bt_js3" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-js-b.png" style="position: absolute;left:0px;top:0px;width:121px; height:47px;">
                        <p id="bt_js_f3" style="position:relative; left:0px; top:11px; width:120px; height:30px; line-height:30px; text-align:center;
                font-size:30px; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;"></p>
                </div>
                <div id="bt_div4" style="position: absolute;left:736px;top:143px;visibility: hidden;">
                        <img id="bt_js4" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-js-b.png" style="position: absolute;left:0px;top:0px;width:121px; height:47px;">
                        <p id="bt_js_f4" style="position:relative; left:0px; top:11px; width:120px; height:30px; line-height:30px; text-align:center;
                font-size:30px; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;"></p>
                </div>
                <div id="bt_div5" style="position: absolute;left:866px;top:143px;visibility: hidden;">
                        <img id="bt_js5" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-js-b.png" style="position: absolute;left:0px;top:0px;width:121px; height:47px;">
                        <p id="bt_js_f5" style="position:relative; left:0px; top:11px; width:120px; height:30px; line-height:30px; text-align:center;
                font-size:30px; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;"></p>
                </div>

                <div id="pagelist">
                        <div style="position:absolute;left:217px;top:220px;display:none;" id="div_xf0">
                                <img id="bt_xjM0" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:30px;height:30px;z-index:10">
                                <img id="bt_xjF0" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-hdra-b.png" style="position: absolute;left:0px;top:0px;width:424px;height:48px;">
                                <p id="bt_xjP0" style="position:relative; left:5px; top:5px; width:416px; height:40px; line-height:40px; text-align:left; font-size:22px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
                        </div>
                        <div style="position:absolute;left:662px;top:220px;display:none;" id="div_xf1">
                                <img id="bt_xjM1" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:30px;height:30px;z-index:10">
                                <img id="bt_xjF1" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-hdra-b.png" style="position: absolute;left:0px;top:0px;width:424px;height:48px;">
                                <p id="bt_xjP1" style="position:relative; left:5px; top:5px; width:416px; height:40px; line-height:40px; text-align:left; font-size:22px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
                        </div>
                        <div style="position:absolute;left:217px;top:288px;display:none;" id="div_xf2">
                                <img id="bt_xjM2" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:30px;height:30px;z-index:10">
                                <img id="bt_xjF2" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-hdra-b.png" style="position: absolute;left:0px;top:0px;width:424px;height:48px;">
                                <p id="bt_xjP2" style="position:relative; left:5px; top:5px; width:416px; height:40px; line-height:40px; text-align:left; font-size:22px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
                        </div>
                        <div style="position:absolute;left:662px;top:288px;display:none;" id="div_xf3">
                                <img id="bt_xjM3" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:30px;height:30px;z-index:10">
                                <img id="bt_xjF3" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-hdra-b.png" style="position: absolute;left:0px;top:0px;width:424px;height:48px;">
                                <p id="bt_xjP3" style="position:relative; left:5px; top:5px; width:416px; height:40px; line-height:40px; text-align:left; font-size:22px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
                        </div>
                        <div style="position:absolute;left:217px;top:356px;display:none;" id="div_xf4">
                                <img id="bt_xjM4" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:30px;height:30px;z-index:10">
                                <img id="bt_xjF4" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-hdra-b.png" style="position: absolute;left:0px;top:0px;width:424px;height:48px;">
                                <p id="bt_xjP4" style="position:relative; left:5px; top:5px; width:416px; height:40px; line-height:40px; text-align:left; font-size:22px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
                        </div>
                        <div style="position:absolute;left:662px;top:356px;display:none;" id="div_xf5">
                               <img id="bt_xjM5" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:30px;height:30px;z-index:10">
                                <img id="bt_xjF5" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-hdra-b.png" style="position: absolute;left:0px;top:0px;width:424px;height:48px;">
                                <p id="bt_xjP5" style="position:relative; left:5px; top:5px; width:416px; height:40px; line-height:40px; text-align:left; font-size:22px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
                        </div>
                        <div style="position:absolute;left:217px;top:424px;display:none;" id="div_xf6">
                               <img id="bt_xjM6" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:30px;height:30px;z-index:10">
                                <img id="bt_xjF6" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-hdra-b.png" style="position: absolute;left:0px;top:0px;width:424px;height:48px;">
                                <p id="bt_xjP6" style="position:relative; left:5px; top:5px; width:416px; height:40px; line-height:40px; text-align:left; font-size:22px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
                        </div>
                        <div style="position:absolute;left:662px;top:424px;display:none;" id="div_xf7">
                                <img id="bt_xjM7" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:30px;height:30px;z-index:10">
                                <img id="bt_xjF7" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-hdra-b.png" style="position: absolute;left:0px;top:0px;width:424px;height:48px;">
                                <p id="bt_xjP7" style="position:relative; left:5px; top:5px; width:416px; height:40px; line-height:40px; text-align:left; font-size:22px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
                        </div>
                        <div style="position:absolute;left:217px;top:492px;display:none;" id="div_xf8">
                                <img id="bt_xjM8" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:30px;height:30px;z-index:10">
                                <img id="bt_xjF8" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-hdra-b.png" style="position: absolute;left:0px;top:0px;width:424px;height:48px;">
                                <p id="bt_xjP8" style="position:relative; left:5px; top:5px; width:416px; height:40px; line-height:40px; text-align:left; font-size:22px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
                        </div>
                        <div style="position:absolute;left:662px;top:492px;display:none;" id="div_xf9">
                                <img id="bt_xjM9" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:0px;top:0px;;width:30px;height:30px;z-index:10">
                                <img id="bt_xjF9" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/detailart-hdra-b.png" style="position: absolute;left:0px;top:0px;width:424px;height:48px;">
                                <p id="bt_xjP9" style="position:relative; left:5px; top:5px; width:416px; height:40px; line-height:40px; text-align:left; font-size:22px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:1"></p>
                        </div>
                </div>
                <!-- 返回按钮 -->
        </div>
        ...
        <div id="scrollid" style="top: 425px; width: 1250px; height: 295px; overflow: hidden; position: absolute; z-index: 9;">
                ...
                <!--<img id="toleftpage0" style="width: 1px; height: 1px;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png">-->
...
<script type="text/javascript">
        ...
        window.document.onkeypress = function (keyEvent) {
                ...
                if (KV == KEY_G_0) {
                	...
                	var str=window.location.href.replace('detail_arts.jsp', 'detail_arts1.jsp')
...
for(SeriesStar star: starlist){
    ...
    actors+="{id: 'item_guest"+(j-1)+"',upButtonId: 'dzl',downButtonId: 'bt_bqw',rightButtonId: 'item_guest"+(j)+"',blurFun: 'F_STAR_BLUR',focusFun: 'F_STAR_FOCUS',enterFun: 'F_TOSTARDETAIL"+(j-1)+"',focusImage: 'item_guest.png',blurImage: 'Pixel.png',leftButtonId:";
    if(j==1){
        actors+="'dp_01'},";
    }else if(j>1){
...
%>
        ...
        var buttons = [{
                        ...
                        <%=actors%>
                {
                        ...
                        blurFun: 'F_E_VBLUR',
                        focusFun: 'F_E_VFOCUS',
                        enterFun: 'F_VIDEO_PLAY',
                        focusImage: 'detailart-xdra-f.png',
                        blurImage: 'Pixel.png'
                },
                {
                        id: 'bt_vf1',
                ...
                },
                {
                        id: 'bt_js0',
                        upButtonId: '',
                        downButtonId: 'bt_xjF0',
                        leftButtonId: 'bt_pdg4',
                        rightButtonId: 'bt_js1',
                        blurFun: '',
                        focusFun: 'F_E_JS',
                        enterFun: '',
                        focusImage: 'detailart-js-f.png',
                        blurImage: 'detailart-js-b.png'
                },
                {
                        id: 'bt_js1',
                        upButtonId: '',
                ...
                },
                {
                        id: 'bt_xjF0',
                        upButtonId: 'bt_pdg2',
                        downButtonId: 'bt_xjF2',
                        leftButtonId: '',
                        rightButtonId: 'bt_xjF1',
                        blurFun: 'F_B_F0',
                        focusFun: 'F_F_F0',
                        enterFun: 'F_VIDEO_PLAY',
                        focusImage: 'detailart-hdra-f.png',
                        blurImage: 'detailart-hdra-b.png'
                },
                {
                        id: 'bt_xjF1',
                        upButtonId: 'bt_pdg2',
                        downButtonId: 'bt_xjF3',
                        leftButtonId: 'bt_xjF0',
                        rightButtonId: 'bt_xjF2',
                        blurFun: 'F_B_F0',
                        focusFun: 'F_F_F0',
                        enterFun: 'F_VIDEO_PLAY',
                        focusImage: 'detailart-hdra-f.png',
                ...
                },
                {
                        id: 'bt_xjF2',
                        upButtonId: 'bt_xjF0',
                        downButtonId: 'bt_xjF4',
                        leftButtonId: 'bt_xjF1',
                        rightButtonId: 'bt_xjF3',
                        blurFun: 'F_B_F0',
                        focusFun: 'F_F_F0',
                        enterFun: 'F_VIDEO_PLAY',
                        focusImage: 'detailart-hdra-f.png',
                ...
                },
                {
                        id: 'bt_xjF3',
                        upButtonId: 'bt_xjF1',
                        downButtonId: 'bt_xjF5',
                        leftButtonId: 'bt_xjF2',
                        rightButtonId: 'bt_xjF4',
                        blurFun: 'F_B_F0',
                        focusFun: 'F_F_F0',
                        enterFun: 'F_VIDEO_PLAY',
                        focusImage: 'detailart-hdra-f.png',
                ...
                },
                {
                        id: 'bt_xjF4',
                        upButtonId: 'bt_xjF2',
                        downButtonId: 'bt_xjF6',
                        leftButtonId: 'bt_xjF3',
                        rightButtonId: 'bt_xjF5',
                        blurFun: 'F_B_F0',
                        focusFun: 'F_F_F0',
                        enterFun: 'F_VIDEO_PLAY',
                        focusImage: 'detailart-hdra-f.png',
                ...
                },
                {
                        id: 'bt_xjF5',
                        upButtonId: 'bt_xjF3',
                        downButtonId: 'bt_xjF7',
                        leftButtonId: 'bt_xjF4',
                        rightButtonId: 'bt_xjF6',
                        blurFun: 'F_B_F0',
                        focusFun: 'F_F_F0',
                        enterFun: 'F_VIDEO_PLAY',
                        focusImage: 'detailart-hdra-f.png',
                ...
                },
                {
                        id: 'bt_xjF6',
                        upButtonId: 'bt_xjF4',
                        downButtonId: 'bt_xjF8',
                        leftButtonId: 'bt_xjF5',
                        rightButtonId: 'bt_xjF7',
                        blurFun: 'F_B_F0',
                        focusFun: 'F_F_F0',
                        enterFun: 'F_VIDEO_PLAY',
                        focusImage: 'detailart-hdra-f.png',
                ...
                },
                {
                        id: 'bt_xjF7',
                        upButtonId: 'bt_xjF5',
                        downButtonId: 'bt_xjF9',
                        leftButtonId: 'bt_xjF6',
                        rightButtonId: 'bt_xjF8',
                        blurFun: 'F_B_F0',
                        focusFun: 'F_F_F0',
                        enterFun: 'F_VIDEO_PLAY',
                        focusImage: 'detailart-hdra-f.png',
                ...
                },
                {
                        ...
                        upButtonId: 'bt_xjF6',
                        downButtonId: '',
                        leftButtonId: 'bt_xjF7',
                        rightButtonId: 'bt_xjF9',
                        blurFun: 'F_B_F0',
                        focusFun: 'F_F_F0',
                        enterFun: 'F_VIDEO_PLAY',
                        focusImage: 'detailart-hdra-f.png',
                ...
                {
                        id: 'bt_bqw', //全文
                        upButtonId: '<%=starlist.size()>0?"item_guest0":"dzl"%>',
...
//						rightButtonId: '',
        ...
        function F_KEY_G_6() { //right
                if (_BS[focus_id]['rightButtonId'].indexOf('bt_js') > -1) {
                        ...
                        if (_SELECT(right).style.visibility == 'hidden') {
                                return;
                        }
                }
                if (_BS[focus_id]['rightButtonId'].indexOf('bt_xjF') > -1) {
                right = _BS[focus_id]['rightButtonId'].replace('bt_xjF', 'div_xf');
        ...
        function F_KEY_G_7() { //down
                if (_BS[focus_id]['downButtonId'].indexOf('bt_xjF') > -1) {
                right = _BS[focus_id]['downButtonId'].replace('bt_xjF', 'div_xf');
                if (_SELECT(right).style.display == 'none') {
                  return;
                }
                }
       ...
       var item_name = '';
        ...
        function F_E_IFOCUS() { //推荐列表focusfun
                ...
                hd_index= focus_id;
              if (item_name.length > 12) {_SELECT(focus_id.replace('f', 'p')).innerHTML = '<marquee direction="left">' + item_name +"</marquee>";}
        }
        ...
        function _H_F(_id) { //旧的焦点去除选中样式，新的焦点添加选中样式
                if (_BS[focus_id] != undefined && _BS[_id] != undefined && _SELECT(focus_id) != undefined && _SELECT(_id) !=
                        ...
                        if (_BS[focus_id]['focusImage'] != 'Pixel.png') {
                                ...
                                if (_F_I_SR != _F_I_SR2) {
                                        if (focus_id.indexOf('bt_xjF') >= 0 || focus_id.indexOf('bt_js') >= 0) {
        ...
        //隐藏选集列表
        function hiddenXJ() {
                _SELECT("bt_div0").style.visibility = "hidden";
                _SELECT("bt_div1").style.visibility = "hidden";
                _SELECT("bt_div2").style.visibility = "hidden";
                _SELECT("bt_div3").style.visibility = "hidden";
                _SELECT("bt_div4").style.visibility = "hidden";
                _SELECT("bt_div5").style.visibility = "hidden";
        }

        function XJnonediv() {
                for (var i = 0; i < 10; i++) {
                        _SELECT("div_xf" + i).style.display = "none";
                }
        }
       ...
       // var video_name = '';
        ...
        function F_E_VFOCUS() { //剧集focus
               // video_name = _SELECT(focus_id.replace('v', 'p')).innerHTML;
                //if (video_name.length > 12) {_SELECT(focus_id.replace('v', 'p')).innerHTML = '<marquee direction="left">' + video_name +"</marquee>";}
        }

        function F_E_VBLUR() { //剧集blur
                //_SELECT(focus_id.replace('v', 'p')).innerHTML = '' + video_name + "";
        }
       // var xj_video_name = '';

        function F_F_F0() { //更多里剧集focus
                //xj_video_name = _SELECT(focus_id.replace('F', 'P')).innerHTML;
                //if (xj_video_name.length > 22) {_SELECT(focus_id.replace('F', 'P')).innerHTML = '<marquee direction="left">' + xj_video_name +"</marquee>";}
        }

        function F_B_F0() { //更多里剧集blur
                //_SELECT(focus_id.replace('F', 'P')).innerHTML =xj_video_name;
        }

        function F_ALLXJ() { //更多剧集
                go_order_div = 'V';
                _SELECT("XJ_LIST").style.display = "block";
                _H_F(pf_d_f);
        }

        function XJ_BACK() { //隐藏更多剧集
                go_order_div = 'N';
                _H_F('bt_vfall');
                _SELECT("XJ_LIST").style.display = "none";
        }

        function jujiclass() {
                XJnonediv();
                i = parseInt(pf_d_f.replace('bt_js', ''));
                var a = dramaSum - 60 * (curentpage - 1) - 10 * i;
                var b = dramaSum - 60 * (curentpage - 1) - 10 * (i + 1) + 1;
                if (a <= 10) {
                        b = 1
                }
                if (a > b) {
                ...
                for (var j = 0; j < len; j++) {
                        if(dramares.bcharging==1&&drama[a - j - 1].bcharging==0){
                          _SELECT("bt_xjM"+j).src = "http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/poster-xmf.png";
                        }else{
                         _SELECT("bt_xjM"+j).src = "http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png";
                      }
                        _SELECT("div_xf" + j).style.display = "block";
                        _SELECT("bt_xjP" + j).innerHTML = drama[a - j - 1].dramaTitle;
                }
        }
        ...
        function F_E_JS() { //剧集分类 focus
                i = parseInt(pf_d_f.replace('bt_js', ''));
                if (_SELECT("bt_div" + i).style.visibility == "visible") {
                        pf_d_f = focus_id;
                }
                jujiclass()
        }
        ...
        function F_XJ_RIGHT() { //剧集分类最后一个 right
                if (page > curentpage){
                        hiddenXJ();
                        var ilength = dramaSum / 10 - 6 * curentpage; //下一页的分类
                        for (var i = 0; i < ilength; i++) {
                                var a = dramaSum - 60 * curentpage - 10 * i;
                                var b = dramaSum - 60 * curentpage - 10 * (i + 1) - 1;
                                if (a <= 10) {
                                        b = 1
                                }
                                _SELECT("bt_div" + i).style.visibility = "visible";
                                _SELECT("bt_js_f" + i).innerHTML = a + "-" + b;
                        }
        ...
        function F_XJ_LEFT() { //剧集分类第一个left
                if (curentpage > 1) {
                        hiddenXJ();
                        for (var i = 0; i < 6; i++) {
                                var a = dramaSum - (60 * (curentpage - 1)) - (10 * i) + 60;
                                var b = dramaSum - (60 * (curentpage - 1)) - (10 * (i + 1) - 1) + 60;
                                if (a <= 10) {
                                        b = 1;
                                }
                                _SELECT("bt_div" + i).style.visibility = "visible";
        ...
        function F_PDG7() { //单个剧集1-4集 down
                var i = parseInt(flag_i.replace("bt_vf", ""));
                var str = (i + 2 == 5 && dramaSum > 6) ? 'bt_drall' : 'bt_dra' + (i + 2)
                if (_SELECT(str).style.display == "none") {
                        _H_F("bt_bplay");
                } else {
                        if (str == 'bt_drall') {
                                _H_F("bt_vfall");
        ...
        function F_PDG8() { //单个剧集all right
                if (flag_i != null && "" != flag_i) {
                        var i = parseInt(flag_i.replace("bt_vf", ""));
                        var str = (i + 1 == 5 && dramaSum > 6) ? 'bt_drall' : 'bt_dra' + (i + 1)
                        if (_SELECT(str).style.display == "block") {
                                if (str == 'bt_drall') {
                                        _H_F("bt_vfall");
                                } else {
                                        _H_F("bt_vf" + (i + 1));
        ...
        function F_VIDEO_PLAY(vv) { //剧集enter
        if(_playtimer){clearInterval(_playtimer)}
            if(drama.length){
                swichversion()
                if (focus_id.indexOf('bt_vf') >= 0) {
                        var i = dramaSum - parseInt(focus_id.replace('bt_vf', ''));
                } else if (focus_id.indexOf('bt_xjF') >= 0) {
                        var j = parseInt(pf_d_f.replace('bt_js', ''));
                        var i = dramaSum - (60 * (curentpage - 1)) - (10 * j) - parseInt(focus_id.replace('bt_xjF', ''));
                }
                i=vv?vv:i;

                var dramaNo=drama[parseInt(i)-1].dramaNo;
                var iscut=(parseInt(cutdrama) == dramaNo)?0:1;
                commen_play('<%=id%>', '<%=programType%>', '<%=HttpLinkUtils.getProgramType_ZH(programType)%>', '<%=code%>','<%=cpcode%>', '<%=pervUrl%>',ordered,dramaSum,iscut,dramaNo,i);
                F_B_PREVWATCH();
           }
        }
        ...
        function F_KEY_M_7() {
                ...
                switch (oEvent.type) {
                        ...
                        case 'EVENT_MEDIA_END':
                                ...
                                // _SELECT("smallWidow").src="smallwindow.jsp?cutTime="+playjson.cutTime+"&playurl="+playjson.url;
       ...
       var _playtimer;
        ...
        if(_playtimer){clearInterval(_playtimer)}
             swichversion();
                ...
                for(var j=0;j<drama.length;j++){
                  if(drama[j].dramaNo==parseInt(cutdrama)){
                    i=j+1;break;
                   }
                }
                var dramaNo=drama[i-1].dramaNo;
            commen_play('<%=id%>', '<%=programType%>', '<%=HttpLinkUtils.getProgramType_ZH(programType)%>','<%=code%>', '<%=cpcode%>','<%=pervUrl%>',ordered,dramaSum,0,'',i);
            F_B_PREVWATCH()
        }
        ...
        function playtishi(drama) {
                ...
                _SELECT("div_prevWatch").innerHTML ="<div id='div_watchPosition' style='position:absolute;left:13px;top:8px; width:258px; height:55px; line-height:35px; text-align:center; font-size:20px; font-weight:600; color:#ffffff; overflow:hidden; margin:0; padding:0;'>您上次观看到第" +drama + "期</div>";
        }
        ...
        function F_F_PREVWATCH() { //播放focus获取播放到哪了
                if (!playjson) {
                        ...
                        var url = webset.api +"video/getSeriesBySeriesCode.json?code=<%=code%>&cp=<%=cpcode%>&volumnCount=" +volumnCount + "&userId=" + userId;
                        $.get(url, function (res) {
                                var res = eval("(" + res + ")");
                                if (res && res.response.responseHeader && res.response.responseHeader.code =='200') {
                                        playjson = res.response.responseBody;
                                       if(playjson.seriesBcharging==1){hasorder()}
                                        else if(_HAS_GD){
                                        ...
                                        _SELECT("smallWidow").src = "smallwindow.jsp?cutTime=" +cuttime+ "&playurl=" + encodeURIComponent(playjson.url) + '&seriesBcharging=' + playjson.seriesBcharging+'&ordered='+ordered+'&cutdrama='+cutdrama+'&programType=<%=programType%>';
                                }else{hasorder()}
                        }, true);
        ...
        var collect_flag = '0';
         ...
         function F_E_SC(flag,str) { //收藏enter
                ...
                $.get(webset.api + 'user/usersearch.json?userId=' + userId + '&combineid=<%=id%>&type=collect&title=' +
                        title,
                        function (res) {
                                var res = eval("(" + res + ")");
                                if (res && res.response.responseHeader && res.response.responseHeader.code ==
                                        '200') {
       ...
       function F_E_SHARE(){//分享
        ...
        function F_E_POINT() { //点赞 enter
                if (flag_zan == 0) {
                        $.get(webset.api + 'user/userscore.json?userId=' + userId +
                                '&combineid=<%=id%>&type=point&score=0',
                                function (res) {
                                        var res = eval("(" + res + ")");
                                        if (res && res.response.responseHeader && res.response.responseHeader.code ==
                                                '200') {
        ...
        var flag_share = 0; //是否点赞
        function F_SHARE_H() { //点赞 focus
             if (flag_share != 0) {
...
//      	if(hasTC)return;
        ...
        function goOrderHint() {
                //var video_charge=window.frames["smallWidow"].getVideoCharge();
                if ("N" == "Y") { //节目收费
                        if ("month" != "month") { //用户未订购
                                //if("N"!="Y"){创维支持小视频播放盒子
                                _SELECT("smallWidow").src = "";
                                GOORDER();
                                //}
                        }
                }
        ...
        function getDrama() {
                $.get(webset.api + 'video/drama.json?userid=' + userId + '&code=<%=code%>&cpCode=<%=cpcode%>', function (res) {
                        ...
                        if (res.response && res.response.responseHeader.code == 200) {
                                ...
                                var len = dramaSum > 6 ? 5 : (dramaSum == 6 ? 6 : dramaSum);
                                for (var i = 0; i < len; i++) {
                                        _SELECT("bt_dra" + i).style.display = "block";
                                        _SELECT("bt_pf" + i).innerHTML = drama[dramaSum - i - 1].dramaTitle;
                                       if(dramares.bcharging==1&&drama[dramaSum - i - 1].bcharging==0){
                                           _SELECT("bt_jbf"+i).src = "http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/poster-xmf.png";
                                        }
                                }
                                row = len % 2 == 0 ? parseInt(len / 2) : parseInt((len + 1) / 2);
                                flag_i = "bt_vf" + (2 * (row - 1));
                                if (dramaSum > 6) {
                                        _SELECT("bt_drall").style.display = "block";
                                }

                                if (dramaSum / 60 > parseInt(dramaSum / 60)) {
                                        page = parseInt(dramaSum / 60) + 1;
                                } else {
                                        page = parseInt(dramaSum / 60);
                                }

                                var ilength = dramaSum / 10;
                                ilength = ilength > 6 ? 6 : ilength;
                                for (var i = 0; i < ilength; i++) {
                                        var a = dramaSum - (10 * i)
                                        var b = dramaSum - (10 * (i + 1) - 1);
                                        if (a <= 10) {
                                                b = 1;
                                        }
                                        _SELECT("bt_div" + i).style.visibility = "visible";
...
//                         if(_playtimer){clearInterval(_playtimer)}
        ...
        function checkGG(){
        	if(haveGG){
        		_SELECT('gd_box').style.display='block';
        		_BS['bt_bsc']['rightButtonId'] = 'bt_gd';
        	}else{
        		_SELECT('gd_box').style.display='none';
        		_BS['bt_bsc']['rightButtonId'] = '';
        	}
        }
        ...
        function F_TODETAIL() {
              ...
              if(tjlist.length){
                ...
                setTimeout(STAT(_stat), 1);
                if(_playtimer){clearInterval(_playtimer)}
                setTimeout(function(){
                	window.location.href = "detail_arts.jsp?id=" + tjlist[i].id + "&programType=" + tjlist[i].videoType +
                    "&code=" + tjlist[i].code + "&cpcode=" + tjlist[i].cpcode + '&prev_focus_id=' + focus_id +
                    '<%=pervUrl%>';
                },80);
