...
<%
	...
	if(!"film".equals(programType)&&!"tv".equals(programType)){
		request.setAttribute("action", "list_02");
%>
...
<body  onload="initdatas()">
    ...
    <div id="partone" style="display: none;">
        <div style="position:absolute;left:259px;top:37px;">
            <p id="rmzt" style="position:absolute; left:0px; top:0px;width:160px;height:45px; text-align:left; font-size:32px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;">热门专题</p>
        </div>
        <div style="position:absolute;left:239px;top:76px;">
            <img id="bt_lms0" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:20px;top:16px;;width:302px;height:163px;" />
            <img id="bt_lmf0" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:5px;top:2px;;width:333px;height:194px;" />
            <img id="bt_lmm0" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/poster-zt-bg.png" style="position: absolute;left:20px;top:16px;;width:302px;height:163px;z-index:11"
            />
            <p id="bt_lmp0" class="p1" style="position:absolute; left:25px; top:150px; width:280px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:11"></p>
        </div>
        <div style="position:absolute;left:560px;top:76px;">
            <img id="bt_lms1" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:20px;top:16px;;width:302px;height:163px;">
            <img id="bt_lmf1" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:5px;top:4px;;width:333px;height:194px;" />
            <img id="bt_lmm1" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/poster-zt-bg.png" style="position: absolute;left:20px;top:16px;;width:302px;height:163px;z-index:11"
            />
            <p id="bt_lmp1" class="p1" style="position:absolute; left:25px; top:150px; width:280px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:11"></p>
        </div>

        <div style="position:absolute;left:881px;top:76px;">
            <img id="bt_lms2" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:20px;top:16px;;width:302px;height:163px;">
            <img id="bt_lmf2" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute;left:5px;top:4px;;width:333px;height:194px;" />
            <img id="bt_lmm2" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/poster-zt-bg.png" style="position: absolute;left:20px;top:16px;;width:302px;height:163px;z-index:11"
            />
            <p id="bt_lmp2" class="p1" style="position:absolute; left:25px; top:150px; width:280px; height:25px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:11"></p>
        </div>
        <div style="position:absolute;left:256px;top:265px;">
            <p style="position:absolute; left:0px; top:0px;width:360px;height:35px; text-align:left; font-size:25px;font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;"></p>
        </div>
        <div id="div_fi0" style="position:absolute;left:256px;top:303px; display:none;">
            ...
            <p id="bt_pi0" class="p1" style="position:absolute; left:0px; top:232px; width:130px; height:23px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:100"></p>
        ...
        <div id="div_fi1" style="position:absolute;left:449px;top:303px; display:none;">
            ...
            <p id="bt_pi1" class="p1" style="position:absolute; left:0px; top:232px; width:130px; height:23px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:100"></p>
        ...
        <div id="div_fi2" style="position:absolute;left:642px;top:303px; display:none;">
            ...
            <p id="bt_pi2" class="p1" style="position:absolute; left:0px; top:232px; width:130px; height:23px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:100"></p>
        ...
        <div id="div_fi3" style="position:absolute;left:835px;top:303px; display:none;">
            ...
            <p id="bt_pi3" class="p1" style="position:absolute; left:0px; top:232px; width:130px; height:23px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:100"></p>
        ...
        <div id="div_fi4" style="position:absolute;left:1028px;top:303px; display:none;">
            ...
            <p id="bt_pi4" class="p1" style="position:absolute; left:0px; top:232px; width:130px; height:23px; line-height:25px; text-align:left; font-family:微软雅黑; font-weight:normal; color:#ffffff; overflow:hidden; margin:0; padding:0;z-index:100"></p>
        ...
        <div id="d_bi5" style="position:absolute;left:256px;top:460px;display: none;">
            <div id="div_bi5" style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png');background-repeat:no-repeat;background-size:100%;background-position:0px 130px;width:176px;height:258px;position: absolute;left:0px;top:0px;z-index:10;">
            </div>
            <img id="im_bi5" style="position: absolute;left:0px;top:130px;width:61px;height:60px;z-index:10;" src="">
            <img id="im_jbi5" style="position: absolute;left:124px;top:130px;width:56px;height:29px;z-index:10;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png">
        </div>
        <div id="d_bi6" style="position:absolute;left:449px;top:460px;display: none;">
            <div id="div_bi6" style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png');background-repeat:no-repeat;background-size:100%;background-position:0px 130px;width:176px;height:258px;position: absolute;left:0px;top:0px;z-index:10;">
            </div>
            <img id="im_bi6" style="position: absolute;left:0px;top:130px;width:61px;height:60px;z-index:10;" src="">
            <img id="im_jbi6" style="position: absolute;left:124px;top:130px;width:56px;height:29px;z-index:10;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png">
        </div>
        <div id="d_bi7" style="position:absolute;left:647px;top:460px;display: none;">
            <div id="div_bi7" style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png');background-repeat:no-repeat;background-size:100%;background-position:0px 130px;width:176px;height:258px;position: absolute;left:0px;top:0px;z-index:10;">
            </div>
            <img id="im_bi7" style="position: absolute;left:0px;top:130px;width:61px;height:60px;z-index:10;" src="">
            <img id="im_jbi7" style="position: absolute;left:124px;top:130px;width:56px;height:29px;z-index:10;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png">
        </div>
        <div id="d_bi8" style="position:absolute;left:835px;top:460px;display: none;">
            <div id="div_bi8" style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png');background-repeat:no-repeat;background-size:100%;background-position:0px 130px;width:176px;height:258px;position: absolute;left:0px;top:0px;z-index:10;">
            </div>
            <img id="im_bi8" style="position: absolute;left:0px;top:130px;width:61px;height:60px;z-index:10;" src="">
            <img id="im_jbi8" style="position: absolute;left:124px;top:130px;width:56px;height:29px;z-index:10;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png">
        </div>
        <div id="d_bi9" style="position:absolute;left:1028px;top:460px;display: none;">
            <div id="div_bi9" style="background-image:url('http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png');background-repeat:no-repeat;background-size:100%;background-position:0px 130px;width:176px;height:258px;position: absolute;left:0px;top:0px;z-index:10;">
            </div>
            <img id="im_bi9" style="position: absolute;left:0px;top:130px;width:61px;height:60px;z-index:10;" src="">
            <img id="im_jbi9" style="position: absolute;left:124px;top:130px;width:56px;height:29px;z-index:10;" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png">
        </div>
    </div>
    <div id="parttwo" style="display: none;">
        <div id="div_fi5" style="position:absolute;left:256px;top:68px; display:none;">
        ...
        <div id="div_fi6" style="position:absolute;left:449px;top:68px; display:none;">
        ...
        <div id="div_fi7" style="position:absolute;left:642px;top:68px; display:none;">
        ...
        <div id="div_fi8" style="position:absolute;left:835px;top:68px; display:none;">
        ...
        <div id="div_fi9" style="position:absolute;left:1028px;top:68px; display:none;">
        ...
        <div id="div_fi10" style="position:absolute;left:256px;top:353px; display:none;">
        ...
        <div id="div_fi11" style="position:absolute;left:449px;top:353px; display:none;">
        ...
        <div id="div_fi12" style="position:absolute;left:642px;top:353px; display:none;">
        ...
        <div id="div_fi13" style="position:absolute;left:835px;top:353px; display:none;">
        ...
        <div id="div_fi14" style="position:absolute;left:1028px;top:353px; display:none;">
...
<script type="text/javascript">
   ...
   var once=true,currentCount=0;//*弹窗*,控制返回是否弹出挽留
    ...
    function F_KEY_G_0() {
    	if(home_focus_id!=""){
    		if(home_focus_id=="ExperienceVoucher"){
    			window.location.href = "http://117.71.47.120:9191/epg/activity/daily_activity/index.jsp";  //体验劵
    		}else if(home_focus_id=="VipMember"){
    			window.location.href = "http://117.71.47.120:9191/epg/login.jsp";  //用户会员中心
    		}else{
   ...
   function GET_INFO_IN(CN) {
    ...
    var buttons = [
        ...
        },
        {
            id: 'bt_fi9',
            upButtonId: 'bt_pdg_g',
            downButtonId: 'bt_fi14',
            leftButtonId: 'bt_fi8',
            rightButtonId: 'bt_fi10',
            blurFun: 'F_B_F00_I',
            focusFun: 'F_E_RF_I',
            enterFun: 'F_E_F0_i',
            focusImage: 'index-poster-f.png',
        ...
        //bt_lmf0、bt_lmf1、 bt_lmf2 热门专题三个模块的id
        {
            id: 'bt_lmf0',
            upButtonId: '',
            downButtonId: 'bt_fi0',
        ...
        $.get(url, function (result) {
            ...
            $.each(json.res.currentPageList, function (i, item) {
                ...
                if (arg == '25ac308705da4fd189e9df3dcb087882') { //专题
                    ...
                    itemid.push(item.id);
                    '<%=programType%>'=='film'||UPDATE_NUM_SET.push(NUM_TRANS_F(item.currentCount,item.volumnCount,'<%=programType%>'))
                    ...
                    if(_INFO_RES_NUM.indexOf(i)>-1){
                        ...
                        _SELECT("bt_sc" + i).innerHTML = '';
                        item_id.push(item.code);
                        '<%=programType%>'=='film'||UPDATE_NUM_SET.push(_SELECT("bt_p" + i).innerHTML)
                        return false
                    }
                    // 广告位end
    ...
    function getHotprograma() {
        ...
        var url = webset.apiStatic + "topic/<%=programType%>/hottopic.json";
        $.get(url, function (result) {
            var json = eval('(' + result + ')');
    ...
    function getHotitems() {
        ...
        $.get(url, function (result) {
            ...
            $.each(json.res.currentPageList, function (i, item) {
                ...
                if (i > 4 && i < 10) {
                    _SELECT("d_bi" + i).style.display = "block";
    ...
    function F_E_F0() {
        if (programa_id_left == '25ac308705da4fd189e9df3dcb087882') {
            ...
            //日志上报
            USER_UPDATA_LOG(itemid[i],"EPG_PROGRAM",i,'<%=HttpLinkUtils.getProgramType_ZH(programType)%>'+'-'+_programa_name_left[_k])
            window.location.href = "detail<%=programType.equals("film")?"":"_"+programType%>.jsp?back=list&programType=<%=programType%>&code=" + item_id[i] + "&id=" + itemid[i] +
    ...
    function F_E_F0_i() {
        ...
        programa_name_left = encodeURI(encodeURI(programa_name_left));
        //日志上报
        USER_UPDATA_LOG(itemid[i],"EPG_PROGRAM",i,'<%=HttpLinkUtils.getProgramType_ZH(programType)%>'+'-'+_programa_name_left[0])        
        window.location.href = "detail<%=programType.equals("film")?"":"_"+programType%>.jsp?back=list&programType=<%=programType%>&code=" + item_id_i[i] + "&id=" + itemid[i] +
    ...
    function F_E_RF() {
        ...
        if ('<%=programType%>'=='film' || programa_id_left == '25ac308705da4fd189e9df3dcb087882') {
            item_name.length > 6 && (_SELECT(focus_id.replace('f', 'p')).innerHTML = '<marquee direction="left">' + item_name + "</marquee>");
        }
        var _ii = parseInt(focus_id.replace('bt_f', ''));
        if('<%=programType%>'=='tv' && programa_id_left != '25ac308705da4fd189e9df3dcb087882'){
    ...
    function F_E_RF_I() {
        ...
        if ('<%=programType%>'=='film' || programa_id_left == '25ac308705da4fd189e9df3dcb087882') {
            item_name_i.length > 6 && (_SELECT(focus_id.replace('f', 'p')).innerHTML = '<marquee direction="left">' + item_name_i + "</marquee>");
        }
