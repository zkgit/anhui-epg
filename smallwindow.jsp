       ...
       var mp,nativePlayerInstanceID;
        ...
        function init_mp() {
            try {
                ...
                mp.playFromStart();
              if(parseInt('<%=seriesBcharging%>')&&!<%=ordered%>&&('<%=programType%>'==('tv'||'documentary')?(cutdrama>3):('<%=programType%>'=='arts'?(cutdrama>1):true))){//付费并且不是会员 电视剧，纪实大于3集，综艺大于1集
                  mp.stop();
...
<div id="test" style="display:none;left: 65px;top: 100px;width:500px;height:100px; color:red;background:#fff; font-size: 14px; position: absolute;word-wrap: break-word; "></div>
