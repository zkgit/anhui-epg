...
<%
	...
	String pervUrl="&back=special_03&focus_id="+focus_id+"&programa_id="+programa_id+"&perv_num="+perv_num+"&perv_count="+(perv_count+1)+"&pf_focus_id="+pf_focus_id+"&home_focus_id="+home_focus_id+"&home_from="+home_from+"&backUrl="+backUrl_encode;
...
//    jsp修改
        ...
        var buttons = [{
                id: 'top_and_down',
                upButtonId: 'transfer_top',
                downButtonId: 'transfer_down',
                rightButtonId: '',
                leftButtonId: '',
                blurFun: '',
                focusFun: '',
        ...
        function foreach(arr) {
            arr.forEach(function (item, index) {
                if (index < 4) {
                    var a = index + 1;
                    if (a == 2) {
                        $("#item_focus").attr("src",  arr[index].focusImage);
                        $("#item_poster").attr("src",  arr[index].posterImage);
                        return;
                    }
        ...
        $(function () {
        	<%
        		String fcode="";
        		if(list.size()>0){
        			fcode=list.get(0).getCode();
        		}
        	%>
            var str = '<%=fcode%>'; //<!-- 海报小图-1,jsp修改 -->

            while (arr[1].seriesCp_id != str) {
                replace();
            }
            foreach(arr);
...
<body onload="init()" style="overflow:hidden;background-repeat:no-repeat;">
    ...
    <!-- 光标 -->
    <img id="top_and_down" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position: absolute; left: 515px; top: 200px; width: 351px; height: 501px; z-index: 10;">

    <!-- 海报光标(焦点图)jsp修改-->
    <img id="item_focus" src="" style="position:absolute;left:26px; top:225px;  width:194px;height:113px;z-index:2">

   <!-- 海报小图(入口图)jsp修改 -->
    <img id="item_show_01" src="" style="position:absolute;left:26px; top:76px; width:194px;height:113px;z-index:2">
    <img id="item_show_03" src="" style="position:absolute;left:26px; top:377px; width:194px;height:113px;z-index:2">
    <img id="item_show_04" src="" style="position:absolute;left:26px; top:531px; width:194px;height:113px;z-index:2">

    <!-- 默认大海报背景jsp修改 -->
    <img id="item_poster" src="" style="position:absolute;left:0px;top:0px;width:1280px;height:720px;z-index:1">


    <!-- 过渡id -->
    <img id="transfer_top" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png">
    <img id="transfer_down" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png">
