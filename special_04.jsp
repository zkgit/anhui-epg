...
<%
	...
	String pervUrl="&back=special_04&focus_id="+focus_id+"&programa_id="+programa_id+"&perv_num="+perv_num+"&perv_count="+(perv_count+1)+"&pf_focus_id="+pf_focus_id+"&home_focus_id="+home_focus_id+"&home_from="+home_from+"&backUrl="+backUrl_encode;
...
<head>
    ...
    <script type="text/javascript">
        ...
        function showInfo(seq) {
            $("#im_b").attr("src",  arr[seq - 1].posterImage);
        ...
        function watchVideo(index) {
            order = index - 1;
            var _cpcode = arr[order].seriesCp_cpCode;
            var _code = arr[order].seriesCp_id;
            var _id = arr[order].id;
    	    ...
    	    if("fd6cc3669a190ab7ac6c8150b6997749".equals(programa_id)||"animation_index".equals(back)){
	    		...
	    		_stat+="-";
	    	%>
	    	var _stat="<%=_stat %>"+arr[order].title;
...
<body onload="init()" style="overflow:hidden;background-repeat:no-repeat;">
    ...
    <%
    	if(list.size()>0){
    		TopicSeries topicSeries=list.get(0);
    %>
    <img id="im_b" src="<%=topicSeries.getPosterUrl2() %>" style="position:absolute;left:0px;top:0px;width:1280px;height:720px;">
	<%} %>
    <!-- 光标 -->
    <img id="left_and_right" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/Pixel.png" style="position:absolute;left:515px; top:200px; width:351px;height:501px;z-index:4">

    
    <!-- 海报光标()-->
    <img id="item_focus_01" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/special-04-f.png" style="position: absolute; left: 105px; top: 425px; z-index: 10;">
    <img id="item_focus_02" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/special-04-f.png" style="display:none;position:absolute;left:321px; top:425px;z-index:3">
    <img id="item_focus_03" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/special-04-f.png" style="display:none;position:absolute;left:535px; top:425px;z-index:3">
    <img id="item_focus_04" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/special-04-f.png" style="display:none;position:absolute;left:752px; top:425px;z-index:3">
    <img id="item_focus_05" src="http://epgpic.kanketv.com.ahct.lv1.vcache.cn/itv-epg/images/special-04-f.png" style="display:none;position:absolute;left:968px; top:425px;z-index:3">

	<!-- 海报小图(入口图)jsp修改 -->
    <%
   		for(int i=1;i<=list.size();i++){
   			TopicSeries topicSeries=list.get(i-1);
   			int left=i*216-100;
  
   	%>
    <img id="item_show_0<%=i %>" src="<%=topicSeries.getPosterUrl3() %>" style="position:absolute;left:<%=left%>px; top:435px;width:182px;height:253px;z-index:2">
    <%
    if(i==5){break;}
   	} %>
